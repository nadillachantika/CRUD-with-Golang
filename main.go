...
func getCustomers(w http.ResponseWriter, r *http.Request) {
	...
	for result.Next() {
		...
		err := result.Scan(&customer.CustomerID, &customer.CompanyName, &customer.ContactName,
			...
			&customer.Phone, &customer.PostalCode, &customer.Fax, &customer.Region)
...
func createCustomer(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == "POST" {
		...
		stmt, err := db.Prepare("INSERT INTO customers (CustomerID,CompanyName,ContactName,ContactTitle,Address,City,Country,Phone,PostalCode,Region,Fax) VALUES (?,?,?,?,?,?,?,?,?,?,?)")

		_, err = stmt.Exec(customerID, companyName, contactName, contactTitle, address, city, country, phone, postalCode, region, fax)
